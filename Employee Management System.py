...
title.grid(row=0, column=2, padx=10, pady=20, sticky="w")
...
txtAddress = Text(entries_frame, width=85, height=2, font=("Calibri", 16))
txtAddress.grid(row=5, column=0, columnspan=4, padx=10, sticky="w")

l1 =Label(entries_frame,width=250, height=250,)
l1.grid(row=0, column=25)
...
def show_frames():
      ...
      #imwrite("C:\Users\shilp\OneDrive\Desktop\Projects\filename.jpg",img)
...
btnCapture= Button(btn_frame, command=show_frames, text="Click !", width=15, font=("Calibri", 16, "bold"), fg="white",
                  bg="#f39c12",
                  bd=0).grid(row=0, column=3, padx=10)
...
tree_frame.place(x=0, y=600, width=1500, height=100)
style = ttk.Style()
